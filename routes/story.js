...
exports.stories=function(req,res){
             Story.find({}, function(err,stories){
                  console.log("Stories session username: " + req.session.username);
...
exports.saveComment=function(req,res){
   ...
   console.log("Saving comment for slug: " + story_slug);
   Story.findOne({slug:story_slug}, function(err,story){

               console.log("comments: " + story.comments);
               console.log("typeof comments: " + typeof(story.comments));
               if (typeof(story.comments) != "Array") {
                   story.comments = new Array();
                   console.log("new typeof comments: " + typeof(story.comments));
               }
